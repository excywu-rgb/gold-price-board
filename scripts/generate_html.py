...
body {{
  font-family: "PingFang SC Rounded", "PingFang SC", "Microsoft YaHei", "Segoe UI", "Helvetica Neue", sans-serif;
  background:
...
h1 {{ font-size: 23px; font-weight: 800; letter-spacing: .03em; }}
h1 .mascot {{
...
h1 small {{ font-size: 13px; font-weight: 500; color: var(--text-2); margin-left: 8px; letter-spacing: .04em; }}
